...
const LoaderScreen = () => {
    return (
        <div className='bg-bgColor w-screen h-screen pb-52 flex flex-col gap-14 justify-center items-center relative' >
            ...
            <div className='absolute bottom-5 flex flex-col items-center justify-center gap-3'>
                ...
                <h3 className='font-title font-medium text-lg text-gray-700 tracking-wider italic'>A Place to Rise Together</h3>
            </div>
